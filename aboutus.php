...
<?php require('inc/header.php'); ?>
    ...
    <div class="kontakti">
      <div class="teksti">
        ...
        <br>
        <p><a href="Home.php"><b>Discover Mediterranenan</b></a> është një udhërrëfyes i specializuar 
...
<br>
          ...
          <p>
            ...
            <br> <br>Synojmë të jemi burimi juaj i besueshëm për këtë rajon të pasur në histori dhe bukuri natyrore!</p>

          <br>
          <h3>CFARE OFROJME NE?</h3>
          <br>
          <p>Ne ofrojme Guide te personalizuar, ndihmë 24/7,
             paketa të personalizuara, <br> blog dhe resurse edukative; Informacione dhe këshilla për udhëtimin tuaj,
